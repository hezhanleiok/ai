      ...
      <body className="flex flex-col min-h-screen bg-[#fafafa]">
          ...
          <div className="max-w-7xl mx-auto px-4 h-20 flex justify-between items-center">
            <div className="flex items-center space-x-10">
              ...
              <div className="hidden md:flex items-center space-x-8 text-sm font-bold text-gray-500">
                ...
                <Link href="/category/article" className="hover:text-blue-600">深度文章</Link>
                {isAdmin && (
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-md">
            <div className="bg-white w-full max-w-md rounded-[2.5rem] p-10 relative shadow-2xl">
              ...
              <form onSubmit={handleEmailAuth} className="space-y-4">
                <input value={email} onChange={(e)=>setEmail(e.target.value)} type="email" placeholder="您的邮箱..." className="w-full p-4 bg-gray-50 rounded-2xl outline-none" required />
                <button type="submit" className="w-full bg-blue-600 text-white py-4 rounded-2xl font-black">发送邮箱链接</button>
        ...
        <footer className="bg-white border-t py-16">
          <div className="max-w-7xl mx-auto px-4 flex justify-center space-x-12">
            <a href="#" className="group"><Github size={40} className="text-gray-300 group-hover:text-black transition-colors" /></a>
            <a href="#" className="group"><Youtube size={40} className="text-gray-300 group-hover:text-red-600 transition-colors" /></a>
            <a href="#" className="group"><Twitter size={40} className="text-gray-300 group-hover:text-blue-400 transition-colors" /></a>
          </div>
        </footer>
      </body>
    </html>
